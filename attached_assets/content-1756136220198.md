[Skip to main content](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap#main-content)
...
- [English](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap)
- [Deutsch](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap?hl=de)
- [Español](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap?hl=es)
- [Français](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap?hl=fr)
- [Indonesia](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap?hl=id)
- [Português – Brasil](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap?hl=pt-br)
- [Русский](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap?hl=ru)
- [中文 – 简体](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap?hl=zh-cn)
- [日本語](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap?hl=ja)
- [한국어](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap?hl=ko)

[Sign in](https://developers.google.com/_d/signin?continue=https%3A%2F%2Fdevelopers.google.com%2Fmaps%2Fdocumentation%2Fjavascript%2Fexamples%2Flayer-heatmap&prompt=select_account)
...
- On this page
- [Try Sample](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap#try-sample)
- [Clone Sample](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap#clone-sample)

reviews **Introducing [Places UI Kit](https://developers.google.com/maps/documentation/javascript/places-ui-kit/overview):** A ready-to-use, low-cost component library that lets you bring the familiar Google Maps UI for Places to any map of your choice. Try it out, and **[share your input to help shape the future of GMP!](https://google.qualtrics.com/jfe/form/SV_bQILAtzbvKIF7Po)**
...
# Heatmaps  bookmark\_border   Stay organized with collections     Save and categorize content based on your preferences.

- On this page
- [Try Sample](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap#try-sample)
- [Clone Sample](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap#clone-sample)

This example overlays a heatmap on top of the map. It includes buttons that
allow users to change the appearance of the heatmap.

Read the [documentation](https://developers.google.com/maps/documentation/javascript/heatmaplayer).

Heatmaps

Toggle HeatmapChange gradientChange radiusChange opacity

![](https://maps.googleapis.com/maps/api/js/StaticMapService.GetMapImage?1m2&1i335196&2i810517&2e2&3u13&4m2&1u300&2u150&5m6&1e2&5sen-US&6sus&10b1&12b1&14i47083502&8e1&key=AIzaSyB41DRUbKWJHPxaFjMAwdrzWzbVKartNGg&token=107506)

BESbswy

[TypeScript](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap#typescript)[JavaScript](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap#javascript)[CSS](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap#css)[HTML](https://developers.google.com/maps/documentation/javascript/examples/layer-heatmap#html)More
...
[JSFiddle.net](https://jsfiddle.net/gh/get/library/pure/googlemaps/js-samples/tree/master/dist/samples/layer-heatmap/jsfiddle) [Google Cloud Shell](https://ssh.cloud.google.com/cloudshell/editor?cloudshell_git_repo=https%3A%2F%2Fgithub.com%2Fgooglemaps%2Fjs-samples&cloudshell_git_branch=sample-layer-heatmap&cloudshell_tutorial=cloud_shell_instructions.md&cloudshell_workspace=.)
