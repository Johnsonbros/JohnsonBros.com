...
1. **Understand before decomposing** - Wrong problem = wasted work
2. **Every step must be trivially solvable** - If it's not, decompose further
3. **Research unknowns, don't guess** - Use 131, Context7, WebSearch
4. **Validate risks early** - Don't build on unproven foundations
5. **Ship MVP first** - Core working > features incomplete
6. **One step at a time** - Build 1, test 1, commit 1
7. **Stay practical** - Theory serves execution, not the reverse
