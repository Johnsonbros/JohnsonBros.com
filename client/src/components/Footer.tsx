        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold" data-testid="footer-company-name">Johnson Bros.</h3>
                <p className="text-gray-400">Plumbing & Drain Cleaning</p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold" data-testid="footer-phone">(617) 479-9911</p>
                  <p className="text-sm text-gray-400">24/7 Emergency Line</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-johnson-blue" />
                <div>
                  <p className="font-semibold" data-testid="footer-email">info@johnsonbros.com</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold" data-testid="footer-location">Quincy, MA</p>
          ...
          <div>
            ...
            <Button 
              ...
              className="w-full bg-johnson-orange text-white px-4 py-3 rounded-lg font-semibold hover:bg-orange-600 transition-colors"
