...
import { format, addDays, startOfWeek, addWeeks, isSameDay, parseISO, isToday, isTomorrow } from 'date-fns';
import type { DatePickerCard as DatePickerCardType } from '@/lib/cardProtocol';

interface DatePickerCardProps {
  card: DatePickerCardType;
...
export function DatePickerCard({ card, onSelectDate, onDismiss, isLoading }: DatePickerCardProps) {
  ...
  const availabilityMap = new Map(
    card.availableDates?.map(d => [d.date, d]) || []
  );
