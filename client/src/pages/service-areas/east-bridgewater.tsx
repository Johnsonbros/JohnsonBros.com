...
export default function EastBridgewaterPlumbing() {
  ...
  const localFAQs = [
    { question: "Do you provide emergency plumbing services in East Bridgewater, MA?", answer: "Yes, Johnson Bros. provides 24/7 emergency plumbing services throughout East Bridgewater, MA." },
    { question: "What areas of East Bridgewater do you service?", answer: "We service all of East Bridgewater and surrounding areas." },
    ...
    { question: "Are you licensed to work in East Bridgewater?", answer: "Yes, we are fully licensed master plumbers in Massachusetts." }
  ];
  const breadcrumbs = [
  ...
  const localReviews = [
    { author: "Mark J. - East Bridgewater", rating: 5, datePublished: "2024-11-14", reviewBody: "Excellent service on our emergency pipe repair!" },
    { author: "Beth C. - East Bridgewater", rating: 5, datePublished: "2024-10-22", reviewBody: "Professional and reliable. Will use again." }
  ];
  const services = [
    ...
    { name: "Water Heater Service East Bridgewater", description: "Water heater repair and installation" },
  ...
  return (
    <>
      ...
      <ServiceAreaSchema areaName="East Bridgewater" services={services} />
      <FAQSchema questions={localFAQs} />
      <BreadcrumbSchema items={breadcrumbs} />
      <ReviewSchema reviews={localReviews} aggregateRating={{ ratingValue: 4.9, reviewCount: 31 }} />
        ...
        <main className="flex-grow">
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                <div className="flex items-center justify-center gap-3 mb-6">
                  ...
                  <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold">Plumber in East Bridgewater, MA</h1>
                </div>
                <p className="text-xl sm:text-2xl mb-8 text-blue-100">Your trusted local plumbing experts serving East Bridgewater</p>
          ...
          <section className="py-16 bg-white">
            <div className="container mx-auto px-4">
              <div className="max-w-6xl mx-auto">
                <h2 className="text-3xl sm:text-4xl font-bold text-center mb-12">Complete Plumbing Services in East Bridgewater, MA</h2>
          ...
          <section className="py-16 bg-gray-50">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-3xl font-bold text-center mb-12">Why East Bridgewater Chooses Johnson Bros.</h2>
              <div className="grid md:grid-cols-3 gap-8">
                {[{ icon: Clock, title: "Fast Response", desc: "Same-day service" }, { icon: Shield, title: "Licensed & Insured", desc: "MA master plumbers" }, { icon: CheckCircle, title: "Local Experts", desc: "We know the area" }].map((f, i) => (<div key={i} className="text-center p-6 bg-white rounded-lg"><f.icon className="h-12 w-12 text-johnson-blue mx-auto mb-4" /><h3 className="text-xl font-semibold mb-3">{f.title}</h3><p className="text-gray-600">{f.desc}</p></div>))}
              </div>
            </div>
          </section>
          ...
          <section className="py-16 bg-gradient-to-br from-johnson-blue to-johnson-teal text-white">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-xl mb-8 text-blue-100">Call East Bridgewater's trusted plumbing experts</p>
